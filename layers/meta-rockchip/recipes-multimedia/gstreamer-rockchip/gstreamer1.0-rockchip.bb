...
SRCREV = "${@bb.utils.contains('GSTREAMER_ROCKCHIP_RELEASE', 'NULL', \
		   '${FIREFLY_SDK_VERSION}', \
		   '${GSTREAMER_ROCKCHIP_RELEASE}', \
		   d)}"

SRC_URI = " \
	git://gitlab.com/firefly-linux/external/gstreamer-rockchip.git;protocol=https;nobranch=1;branch=${FIREFLY_SDK_BRANCH}; \
"
